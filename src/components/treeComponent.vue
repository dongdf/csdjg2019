        ...
        <div class="ivu-modal" style="width: 520px; top:30%;">
          <div class="ivu-modal-content"><a class="ivu-modal-close"><i @click="close"
            ...
            <div class="ivu-modal-body">
              <Alert v-show="showtips" type="warning">请选择行业</Alert>
                <Tree ref="tree" :data="data3" class="ntree"  :load-data="loadData"></Tree>
                <!--<div >请选择行业</div>-->
  ...
  export default {
    ...
    methods: {
      ...
      getSelectTree(){
        ...
        // console.log(typeof(this.selectedTree.pid))
        if(!this.selectedTree || typeof(this.selectedTree.pid) == 'undefined'){
          this.showtips = true;
          setTimeout(()=>{
            this.showtips = false;
          },2000)
