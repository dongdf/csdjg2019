  ...
  <div>
    ...
    <div>
      <Row class="newStep" >
        ...
        <Col span="1"><div class="jt"><img src="./img/jt.png"></div></Col>
        <Col span="4">
        <div class="setpItem"  @click="changeSetp(1)" :class="cur == 1?'setpCur':''">
          <div class="setpc">

            <div class="icon icon2"><i>2</i></div>
            <div class="icon_text">2016年数据上传</div>
          </div>
        </div>
        </Col>
        <Col span="1"><div class="jt"><img src="./img/jt.png"></div></Col>
        ...
        <div class="setpItem"  @click="changeSetp(2)" :class="cur == 2?'setpCur':''">
          <div class="setpc">
            ...
            <div class="icon icon2"><i>3</i></div>
            <div class="icon_text">2017年数据上传</div>
          </div>
        </div>
        </Col>
        <Col span="1"><div class="jt"><img src="./img/jt.png"></div></Col>
        ...
        <div class="setpItem" @click="changeSetp(3)" :class="cur == 3?'setpCur':''">
          <div class="setpc">
            ...
            <div class="icon icon2"><i>4</i></div>
            <div class="icon_text">2018年数据上传</div>
          </div>
        </div>
        </Col>
        <Col span="1"><div class="jt"><img src="./img/jt.png"></div></Col>
   ...
   <div class="stepcon">
     ...
     <div class="con1" v-if="cur == 1">
       ...
       <br>
       <center> <Button type="warning" size="large" @click="opencj">一键采集数据</Button>&nbsp;&nbsp;&nbsp;&nbsp;<Button type="primary" size="large" @click="changeSetp(2)">下一步</Button></center>
     ...
     <div class="con1" v-if="cur == 2">
       ...
       <br>
       <center> <Button type="warning" size="large" @click="opencj">一键采集数据</Button>&nbsp;&nbsp;&nbsp;&nbsp;<Button type="primary" size="large" @click="changeSetp(3)">下一步</Button></center>
     ...
     <div class="con1" v-if="cur == 3">
       ...
       <br>
       <center> <Button type="warning" size="large" @click="opencj">一键采集数据</Button>&nbsp;&nbsp;&nbsp;&nbsp;<Button type="primary" size="large" @click="changeSetp(4)">下一步</Button></center>
...
<script>
  ...
  export default {
    ...
    methods:{
      opencj(){
        var bburl = REDIRECT_URL+'/ti_tool?lx='+this.selCompany.accountant_rule+"&company_flag="+this.selCompany.company_flag;
        window.open(bburl)
      ...
      changeSetp(idx){
        ...
        this.$router.push({name:'grade',query:{cur:idx,id:this.selCompany.id,edit:this.editAttr}});
      }
    }
...
<style lang="scss" scoped>
  ...
  .setpItem{
    ...
    .setpc{
      ...
      .icon2{
        background: url("./img/2-0.png") no-repeat center;
        background-size: 100%;
      }
      .icon3{
        background: url("./img/2-0.png") no-repeat center;
      ...
      .icon5{
        background: url("./img/3-0.png") no-repeat center;
        background-size: 100%;
      }
      .icon_text{
        padding:5px;
