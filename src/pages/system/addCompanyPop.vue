            ...
            <div>
              <div class="formdata">
                ...
                <Form ref="formValidate" :model="formItem" :rules="ruleValidate" :label-width="80">
                  ...
                  <FormItem v-if="!cinfo" label="企业规模" prop="companyFlag" >
...
<script>
  ...
  export default {
    ...
    if(this.cinfo){
      ...
      if(this.cinfo.company_flag){
        this.formItem.companyFlag = this.cinfo.company_flag+'';
      }
            ...
            if(this.cinfo){//编辑
              ...
              this.$http.post('financial/companyService/update',{
                "subData":{
                  ...
                  "company_flag":this.formItem.companyFlag,
